...
export default async function wsActorClient(pi: ExtensionAPI) {
  ...
  const fences=new Map<string,Fence>();const peerCache=new Map<string,PeerMetadata>();let sourcePeer:PeerMetadata|undefined;const mutations=new ClientMutationSequencer();let rosterState=initialActorClientRosterState();
