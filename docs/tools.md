...
| tmux, TPM-installed plugins | tmux/TPM aren't host-tool binaries in the same sense | `home/dot_local/share/lazyvim/lua/setup/capabilities/tmux.lua`, `home/dot_tmux.conf` |
