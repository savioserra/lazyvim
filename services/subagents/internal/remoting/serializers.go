...
func PublicAgentSerializers() []remote.Option {
	...
	return []remote.Option{
		...
		remote.WithSerializers(new(application.ResolveAgentActor), cbor),
		remote.WithSerializers(new(application.AgentActorRef), cbor),
		...
		remote.WithSerializers(new(application.RequestTaskCredit), cbor),
		remote.WithSerializers(new(application.TaskCreditGranted), cbor),
		remote.WithSerializers(new(application.TaskBackpressured), cbor),
